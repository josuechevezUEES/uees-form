    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    @include('livewire.tip-tipos-preguntas.modals')
                            ...
                            <tbody>
                                @forelse($tipTiposPreguntas as $row)
                                    <tr>
                                        ...
                                        <td>{{ $row->nombre }}</td>
                                        <td>{{ $row->entrada }}</td>
                                        <td>{{ $row->comentario ? 'Activo' : 'Desactivado' }}</td>
                                                ...
                                                <ul class="dropdown-menu">
                                                    ...
                                                    <li>
                                                        <a class="dropdown-item"
                                                            onclick="confirm('Confirmar la eliminacion de {{ $row->nombre }}?')||event.stopImmediatePropagation()"
